// Generated from: tests\features\homepage\homePageHeadersAndFooters.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\homepage\\homePageHeadersAndFooters.feature'), { scope: 'test', box: true }],
