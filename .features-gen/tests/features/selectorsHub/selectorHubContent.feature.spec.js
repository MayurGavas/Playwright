// Generated from: tests\features\selectorsHub\selectorHubContent.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\selectorsHub\\selectorHubContent.feature'), { scope: 'test', box: true }],
