// Generated from: tests\features\selectorsHub\selectorsHubFrequentlyAskedQuestions.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\selectorsHub\\selectorsHubFrequentlyAskedQuestions.feature'), { scope: 'test', box: true }],
